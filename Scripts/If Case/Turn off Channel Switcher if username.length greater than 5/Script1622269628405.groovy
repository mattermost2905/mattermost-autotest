...
WebUI.click(findTestObject('Object Repository/Turn off Channel Switcher if username.length greater than 5/button_Account Settings'))

WebUI.click(findTestObject('Object Repository/Turn off Channel Switcher if username.length greater than 5/button_Sidebar'))

WebUI.click(findTestObject('Object Repository/Turn off Channel Switcher if username.length greater than 5/div_Channel SwitcherEdit'))

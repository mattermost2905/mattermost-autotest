...
WebUI.callTestCase(findTestCase('Internal/Choose search options'), [:], FailureHandling.STOP_ON_FAILURE)
...
switch (choose) {
    ...
    case 'in':
        ...
        WebUI.click(findTestObject('Search/div_Town Squaretown-square'))
